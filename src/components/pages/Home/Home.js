...
export default function Home(props) {
    ...
    return (
        ...
        <div style={{backgroundColor: props.dark ? "#282D35" : "white"}} className="completepage home">
            ...
            <iframe width="600" height="350" src="https://www.youtube.com/embed/-KzTgGoOn-w?si=kVZ7RN4WIAjTHKRP" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen className="video"></iframe>
