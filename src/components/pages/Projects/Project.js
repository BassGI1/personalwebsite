...
export default function Project(props) {
    ...
    return (
        ...
        <div className="project">
            ...
            <img src={process.env.PUBLIC_URL + `/projectImages/${props.src}`} alt="pic" style={{display: "flex", height: "40vh", margin: "auto auto 3vh auto", border: "solid 2.5px #de2323", borderRadius: "3vh"}}/>
